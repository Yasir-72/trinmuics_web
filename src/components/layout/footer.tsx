  ...
  return (
    <footer className="bg-[#0b1d37] text-gray-200 py-12 shadow-[0_-4px_20px_rgba(0,0,0,0.2)]">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Middle Section */}
        <div>
          <h2 className="text-lg font-bold mb-5 text-[#d4af37]">Quick Links</h2>
        ...
        {/* Right Section */}
        <div>
          <h2 className="text-lg font-bold mb-5 text-[#d4af37]">Contact Us</h2>
          ...
          <div className="flex space-x-4 mt-5">
            <a
              href="#"
              className="bg-[#d4af37] p-2 rounded-full text-[#0b1d37] hover:bg-[#c19d2d] transition shadow-md"
            >
              <FaTwitter />
            </a>
            <a
