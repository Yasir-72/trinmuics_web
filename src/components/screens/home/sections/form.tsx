        ...
        <div className="bg-purple-900 text-white p-8 rounded-2xl shadow-xl">
          ...
          <div className="space-y-10 relative">
            ...
            <div className="flex items-start relative">
              ...
              <p>
                Our experts will analyze your requirements and contact you within{" "}
            ...
            <div className="flex items-start relative">
              ...
              <p>
                We will collect all requirements for your project, and if needed,{" "}
                sign an <span className="font-semibold">NDA</span> to ensure privacy.
              </p>
            </div>
            ...
            <div className="flex items-start relative">
              ...
              <p>
                ...
                <span className="font-semibold">proposal and action plan</span> for your
                project with timelines, estimates, and deliverables.
              </p>
            </div>
          </div>
        </div>
